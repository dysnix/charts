...
| `args`                                  | Override default container args (useful when using custom images)                                     | `["-conf=/etc/proxy/configs/configs.yaml"]`       |
...
| `cacheType`                             | Defines eth cacher storage type                                                                       | `redis`                                           |
